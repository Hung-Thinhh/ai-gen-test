...
export default function PodPage() {
    ...
    return (
        <div className="min-h-screen bg-[#09090b] text-white overflow-x-hidden">
            <LeonardoHeader />
            <MobileHeader title="Print on Demand" />
            ...
            <style jsx global>{`
                ...
                .glass-card-green { background: rgba(255,255,255,0.03); backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.08); transition: all 0.5s; }
                .glass-card-green:hover { background: rgba(255,255,255,0.06); border-color: rgba(249,115,22,0.3); transform: translateY(-4px); box-shadow: 0 20px 40px rgba(0,0,0,0.3), 0 0 30px rgba(249,115,22,0.1); }
                .gradient-text-green { background: linear-gradient(135deg, #f97316, #fb923c, #f97316); background-size: 200% auto; -webkit-background-clip: text; -webkit-text-fill-color: transparent; animation: shimmer 4s linear infinite; }
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
                        <div className="space-y-5 sm:space-y-7 text-center lg:text-left">
                            <div className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-orange-500/10 border border-orange-500/20 ${hero.isVisible ? 'animate-fadeUp' : 'opacity-0'}`}>
                                ...
                                <span className="text-orange-400 text-xs sm:text-sm font-medium">Print on Demand</span>
                            </div>
                            <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-[3.5rem] font-bold leading-[1.15] ${hero.isVisible ? 'animate-fadeUp-d1' : 'opacity-0'}`}>
                                Thiết kế sản phẩm{' '}
                                <span className="gradient-text-green">Print on Demand</span>{' '}
                                bằng AI
                            </h1>
                            <p className={`text-base sm:text-lg text-zinc-400 leading-relaxed max-w-xl mx-auto lg:mx-0 ${hero.isVisible ? 'animate-fadeUp-d2' : 'opacity-0'}`}>
                                Áo thun, mug, phone case, tote bag — tạo mockup chuyên nghiệp và thiết kế pattern
                                sẵn sàng in trong vài giây.
                            </p>
                            <div className={`flex flex-col sm:flex-row flex-wrap gap-3 sm:gap-4 pt-2 justify-center lg:justify-start ${hero.isVisible ? 'animate-fadeUp-d3' : 'opacity-0'}`}>
                                <Link href="/tool/product-mockup" className="group px-7 sm:px-8 py-3.5 sm:py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300 text-center animate-pulseGlow">
                                    Thử Product Mockup
                            ...
                            <div className={`flex items-center gap-4 sm:gap-6 justify-center lg:justify-start ${hero.isVisible ? 'animate-fadeUp-d4' : 'opacity-0'}`}>
                                {['File sẵn sàng in', 'Mockup 3D thực tế', 'Tiếng Việt'].map((t, i) => (
                        ...
                        <div className={`relative mt-4 lg:mt-0 ${hero.isVisible ? 'animate-slideRight' : 'opacity-0'}`}>
                            ...
                            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl shadow-orange-500/10">
                                <img src="https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=600&h=700&fit=crop" alt="Print on Demand Products" className="w-full h-[260px] sm:h-[360px] md:h-[420px] lg:h-[520px] object-cover" />
                                <div className="absolute bottom-4 left-4 right-4 glass-card-green rounded-xl p-3 sm:p-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div><p className="text-sm font-semibold text-white">Mockup áo thun hoàn tất</p><p className="text-xs text-zinc-400">4 góc nhìn • 3 giây</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section className="py-5 sm:py-6 px-4 sm:px-6 border-y border-white/[0.06] bg-white/[0.01]">
                <div className="container mx-auto max-w-6xl">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6">
                        <p className="text-xs sm:text-sm text-zinc-500 text-center md:text-left">Công cụ POD AI được seller tin dùng</p>
                        <div className="flex items-center gap-8 sm:gap-12 md:gap-16">
                            <div className="text-center"><div className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">100+</div><div className="text-[10px] sm:text-xs text-zinc-500">Template mockup</div></div>
                            <div className="text-center"><div className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">PNG/SVG</div><div className="text-[10px] sm:text-xs text-zinc-500">Print-ready file</div></div>
                            <div className="text-center"><div className="text-lg sm:text-xl md:text-2xl font-bold text-orange-400">300 DPI</div><div className="text-[10px] sm:text-xs text-zinc-500">Chất lượng in ấn</div></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-14 sm:py-18 md:py-24 px-4 sm:px-6 bg-[#09090b] relative overflow-hidden">
                ...
                <div ref={stats.ref} className={`container mx-auto max-w-5xl relative z-10 transition-all duration-700 ${stats.isVisible ? 'opacity-100' : 'opacity-0'}`}>
                    <p className={`text-center text-zinc-300 text-base sm:text-lg mb-10 sm:mb-14 px-2 ${stats.isVisible ? 'animate-fadeUp' : ''}`}>
                        Hàng ngàn seller POD đã tăng doanh thu với Duky AI
                    </p>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-4">
                        {[
                            { target: 200000, suffix: '+', label: 'Mockup đã tạo', sub: 'sản phẩm POD mỗi tháng', delay: 'd1' },
                            { target: 100, suffix: '+', label: 'Template sản phẩm', sub: 'áo, mug, case, tote...', delay: 'd2' },
                            { target: 5, suffix: 'x', label: 'Tăng conversion', sub: 'nhờ mockup chuyên nghiệp', delay: 'd3' }
                        ].map((stat, i) => (
                            <div key={i} className={`glass-card-green rounded-2xl p-6 sm:p-8 text-center cursor-default ${stats.isVisible ? `animate-fadeUp-${stat.delay}` : 'opacity-0'}`}>
                                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 sm:mb-3">
                                    <span className="gradient-text-green"><AnimatedCounter target={stat.target} suffix={stat.suffix} /></span>
                                </div>
                ...
                <div ref={features.ref} className="container mx-auto max-w-6xl">
                    <div className={`text-center mb-12 sm:mb-16 transition-all duration-700 ${features.isVisible ? 'animate-fadeUp' : 'opacity-0'}`}>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 sm:mb-5 px-2">
                            Công cụ POD AI <span className="gradient-text-green">chuyên biệt</span>
                        </h2>
                        <p className="text-zinc-400 max-w-2xl mx-auto leading-relaxed text-sm sm:text-base px-2">
                            Mockup sản phẩm, thiết kế pattern, xóa nền — tất cả để bạn bán hàng nhanh hơn.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
                        {podTools.map((tool, index) => (
                            <Link key={index} href={tool.href} className={`group glass-card-green rounded-2xl p-5 sm:p-6 cursor-pointer ${features.isVisible ? `animate-fadeUp-d${index + 1}` : 'opacity-0'}`}>
            ...
            <section className="py-12 sm:py-16 px-4 sm:px-6 bg-black/50">
                <div ref={promo.ref} className="container mx-auto max-w-6xl">
                    <h2 className={`text-lg sm:text-xl text-zinc-500 mb-6 text-center ${promo.isVisible ? 'animate-fadeUp' : 'opacity-0'}`}>Bán trên mọi nền tảng POD</h2>
                    <div className={`flex flex-wrap justify-center items-center gap-6 sm:gap-10 md:gap-14 mb-10 sm:mb-14 ${promo.isVisible ? 'animate-fadeUp-d1' : 'opacity-0'}`}>
                        {['ETSY', 'AMAZON', 'SHOPEE', 'REDBUBBLE', 'TEEPUBLIC'].map((platform, i) => (
                            <div key={i} className="text-sm sm:text-lg md:text-xl font-bold tracking-[0.2em] text-zinc-600 hover:text-orange-400/60 transition-colors duration-300 cursor-default">{platform}</div>
                        ))}
                    </div>
                        ...
                        <div className="relative z-10 p-7 sm:p-10 md:p-14 border border-white/[0.06] rounded-2xl">
                            <div className="max-w-xl">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/15 text-orange-400 text-xs sm:text-sm mb-4">
                                    ...
                                    Ý tưởng → Mockup → Listing
                                </div>
                                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4 leading-tight">
                                    Upload design — AI tạo mockup.<br />
                                    <span className="text-zinc-400">Bán ngay. Không cần chụp ảnh.</span>
                                </h3>
                                <p className="text-sm sm:text-base text-zinc-400 mb-6 leading-relaxed">
                                    Tạo ảnh sản phẩm chuyên nghiệp cho listing Etsy, Amazon, Shopee —
                                    không cần mua mẫu, không cần studio.
                                </p>
                                <Link href="/tool/product-mockup" className="group inline-flex items-center gap-2 text-orange-400 hover:text-orange-300 transition-colors text-sm sm:text-base font-medium">
                                    Tạo Mockup ngay
            ...
            <section className="py-14 sm:py-18 md:py-24 px-4 sm:px-6 bg-[#09090b]">
                <div ref={process.ref} className="container mx-auto max-w-5xl">
                    <div className={`text-center mb-12 sm:mb-16 ${process.isVisible ? 'animate-fadeUp' : 'opacity-0'}`}>
                        <span className="gradient-text-green text-lg sm:text-xl font-semibold">3 bước tạo mockup POD chuyên nghiệp</span>
                    </div>
                ...
                <div className="container mx-auto max-w-6xl">
                    <div ref={zigzag1.ref} className="grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center mb-20 sm:mb-28">
                        <div className={`space-y-5 ${zigzag1.isVisible ? 'animate-slideLeft' : 'opacity-0'}`}>
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20"><span className="text-orange-400 text-xs sm:text-sm font-medium">PRODUCT MOCKUP</span></div>
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">Mockup sản phẩm 3D<br /><span className="text-zinc-400">chỉ trong 3 giây</span></h2>
                            <p className="text-sm sm:text-base text-zinc-400 leading-relaxed">Upload thiết kế lên áo thun, mug, phone case, tote bag — AI tạo mockup 3D chân thực với nhiều góc nhìn và màu sắc.</p>
                            <ul className="space-y-3">
                                {['Hàng trăm template sản phẩm có sẵn', 'Mockup nhiều góc: trước, sau, nghiêng', 'Xuất ảnh 300 DPI sẵn sàng cho listing'].map((item, i) => (
                            ...
                            <Link href="/tool/product-mockup" className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl font-semibold text-sm sm:text-base text-white hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300">
                                Tạo Mockup <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                            </Link>
                        </div>
                        <div className={`relative ${zigzag1.isVisible ? 'animate-slideRight' : 'opacity-0'}`}>
                            ...
                            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1503341504253-dff4f94032fc?w=600&h=400&fit=crop" alt="Product Mockup" className="w-full h-[220px] sm:h-[300px] md:h-[380px] object-cover" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div ref={zigzag2.ref} className="grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
                        <div className={`relative order-2 lg:order-1 ${zigzag2.isVisible ? 'animate-slideLeft' : 'opacity-0'}`}>
                            ...
                            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=600&h=400&fit=crop" alt="Product Scene" className="w-full h-[220px] sm:h-[300px] md:h-[380px] object-cover" />
                            </div>
                        </div>
                        <div className={`space-y-5 order-1 lg:order-2 ${zigzag2.isVisible ? 'animate-slideRight' : 'opacity-0'}`}>
                            ...
                            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight">Đặt sản phẩm vào<br /><span className="text-zinc-400">bối cảnh bán hàng thực</span></h2>
                            <p className="text-sm sm:text-base text-zinc-400 leading-relaxed">AI tạo lifestyle scene cho sản phẩm POD — bàn làm việc, phòng khách, ngoài trời, phong cách nào cũng có.</p>
                            <Link href="/tool/product-scene" className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl font-semibold text-sm sm:text-base text-white hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300">
                                Tạo Product Scene <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                            </Link>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-14 sm:py-18 md:py-24 px-4 sm:px-6 bg-[#09090b]">
                <div ref={tools.ref} className="container mx-auto max-w-6xl">
                    <div className={`text-center mb-10 sm:mb-14 ${tools.isVisible ? 'animate-fadeUp' : 'opacity-0'}`}>
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Và <span className="gradient-text-green">nhiều công cụ</span> hỗ trợ POD</h2>
                    </div>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4">
                        {morePodTools.map((tool, index) => (
                            <Link key={index} href={tool.href} className={`group glass-card-green rounded-xl p-4 sm:p-5 cursor-pointer ${tools.isVisible ? `animate-fadeUp-d${Math.min(index + 1, 5)}` : 'opacity-0'}`}>
            ...
            <section ref={banner.ref} className="relative h-[300px] sm:h-[380px] md:h-[460px] lg:h-[520px] overflow-hidden">
                <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?w=1600&h=800&fit=crop" alt="POD Business" className="w-full h-full object-cover" />
                ...
                <div className={`absolute inset-0 flex items-center transition-all duration-1000 ${banner.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <div className="container mx-auto max-w-6xl px-4 sm:px-6">
                        <div className="max-w-lg">
                            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/20 text-orange-400 text-xs sm:text-sm mb-4"><div className="w-1.5 h-1.5 rounded-full bg-orange-400 animate-pulse"></div>POD Tools</div>
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight">Bắt đầu kinh doanh POD <span className="gradient-text-green">ngay hôm nay</span></h2>
                            <p className="text-sm sm:text-base text-zinc-300 mb-6">Đăng ký miễn phí. Tạo mockup đầu tiên trong 30 giây.</p>
                            <Link href="/tool/product-mockup" className="group inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-orange-500 to-red-500 rounded-xl font-semibold text-white hover:shadow-lg hover:shadow-orange-500/25 transition-all duration-300">
                                Tạo Mockup — Miễn phí <svg className="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" /></svg>
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <div ref={enterprise.ref} className="container mx-auto max-w-6xl">
                    <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 md:gap-16 items-center">
                        <div className={`transition-all duration-700 ${enterprise.isVisible ? 'animate-slideLeft' : 'opacity-0'}`}>
                            <div className="glass-card-green rounded-2xl p-7 sm:p-9 md:p-11 hover:transform-none">
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 mb-5"><span className="text-orange-400 text-xs sm:text-sm font-medium">POD AGENCY</span></div>
                                <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-4 leading-tight">Giải pháp POD AI<br /><span className="text-zinc-400">cho team & agency</span></h2>
                                <p className="text-sm sm:text-base text-zinc-400 mb-6 leading-relaxed">Batch processing hàng trăm mockup cùng lúc, quản lý design library, và API tích hợp cho print fulfillment workflow.</p>
                                <ul className="space-y-3 mb-7">
                                    {['Batch tạo mockup hàng loạt', 'API tích hợp Printful, Printify', 'Quản lý design library team'].map((item, i) => (
                        ...
                        <div className={`relative ${enterprise.isVisible ? 'animate-slideRight' : 'opacity-0'}`}>
                            <div className="absolute -inset-4 bg-gradient-to-r from-orange-500/15 to-red-500/15 rounded-3xl blur-3xl"></div>
                            <div className="relative rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
                                <img src="https://images.unsplash.com/photo-1556740758-90de374c12ad?w=600&h=450&fit=crop" alt="POD Business Team" className="w-full h-[220px] sm:h-[320px] md:h-[400px] object-cover" />
                            </div>
                        </div>
                    </div>
                </div>
...
/* ═══════════ DATA ═══════════ */
const podTools = [
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M21 16V8a2 2 0 00-1-1.73l-7-4a2 2 0 00-2 0l-7 4A2 2 0 003 8v8a2 2 0 001 1.73l7 4a2 2 0 002 0l7-4A2 2 0 0021 16z" /></svg>, title: 'Product Mockup', description: 'Mockup 3D cho áo thun, mug, case, tote bag — giống thật 100%.', href: '/tool/product-mockup' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" /></svg>, title: 'Product Scene', description: 'Đặt sản phẩm vào lifestyle scene chân thực.', href: '/tool/product-scene' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" /></svg>, title: 'Concept Studio', description: 'Tạo concept design pattern cho sản phẩm POD.', href: '/tool/concept-studio' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" /></svg>, title: 'Poster Creator', description: 'Tạo poster quảng cáo sản phẩm POD nổi bật.', href: '/tool/poster-creator' }
];

const processSteps = [
    { title: 'Upload thiết kế', description: 'Upload file design PNG/SVG hoặc tạo mới trực tiếp bằng AI.' },
    { title: 'Chọn sản phẩm', description: 'Chọn từ 100+ template: áo, mug, phone case, tote bag...' },
    { title: 'Tải mockup & bán', description: 'Tải mockup chuyên nghiệp, đăng lên shop bắt đầu bán ngay.' }
];

const morePodTools = [
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0" /></svg>, title: 'Background Remover', desc: 'Xóa nền sản phẩm tức thì', href: '/tool/object-remover' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" /></svg>, title: 'Swap Style', desc: 'Chuyển phong cách design', href: '/tool/swap-style' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M15.042 21.672L13.684 16.6m0 0l-2.51 2.225.569-9.47 5.227 7.917-3.286-.672zM12 2.25V4.5m5.834.166l-1.591 1.591M20.25 10.5H18M7.757 14.743l-1.59 1.59M6 10.5H3.75m4.007-4.243l-1.59-1.59" /></svg>, title: 'Inpainter', desc: 'Chỉnh sửa chi tiết design', href: '/tool/inpainter' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5m.75-9l3-3 2.148 2.148A12.061 12.061 0 0116.5 7.605" /></svg>, title: 'Process Creator', desc: 'Ảnh quy trình sản phẩm', href: '/tool/product-process-creator' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.383a14.406 14.406 0 01-3 0M14.25 18v-.192c0-.983.658-1.823 1.508-2.316a7.5 7.5 0 10-7.517 0c.85.493 1.509 1.333 1.509 2.316V18" /></svg>, title: 'Free Generation', desc: 'Tạo pattern & design tự do', href: '/tool/free-generation' },
    { icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42" /></svg>, title: 'Typography', desc: 'Typography nghệ thuật cho POD', href: '/tool/typographic-illustrator' }
];
