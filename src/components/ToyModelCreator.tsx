                    ...
                    >
                        ...
                        <OptionsPanel>
                            ...
                            <div className="flex items-center justify-end gap-4 pt-4">
                                ...
                                <button onClick={executeInitialGeneration} className="btn btn-primary" disabled={isLoading || !appState.uploadedImage}>{isLoading ? t('toyModelCreator_creating') : t('toyModelCreator_createButton')}</button>
                            </div>
                        </OptionsPanel>
                    </motion.div>
                )}
