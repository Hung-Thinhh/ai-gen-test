    ...
    return (
        <div className="w-full px-4 mb-12">
            <motion.div
                ...
                className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange-600 via-orange-500 to-yellow-500 p-8 md:p-12 shadow-2xl shadow-orange-500/20 max-w-6xl mx-auto"
            >
                {/* Background Shapes */}
