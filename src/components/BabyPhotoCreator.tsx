        ...
        <div className="flex flex-col items-center justify-center w-full h-full flex-1 min-h-screen">
            ...
            {(appState.stage === 'idle' || appState.stage === 'configuring') && (
                ...
                >
                        ...
                        <div className="w-full max-w-4xl text-center mt-4">
                            ...
                            <div className="mb-4">
                                <button
                                    ...
                                    disabled={isLoading || isEstimatingAge || !appState.uploadedImage}
                                >
                                    ...
                                    <div key={categoryObj.category}>
                                        <h3 className="text-xl base-font font-bold text-orange-400 text-left mb-3 sticky top-[-20px] bg-black/80 py-2 -mx-4 px-4 z-10 flex items-center gap-2">
                                            ...
                                            {categoryObj.key === 'random' && (
                                                <span className="text-xs font-normal bg-orange-400/20 text-orange-300 px-2 py-0.5 rounded-full flex items-center gap-1">
                    ...
                    <div className="w-full max-w-4xl mx-auto mt-2 space-y-4 px-4">
                        <div>
